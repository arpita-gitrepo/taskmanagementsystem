        ...
        <div>
            <form className='space-y-4 p-4' onSubmit={handleSubmit}>
                <div className='flex justify-center items-center mt-4 mb-2'>
                    <h2 className='text-xl sm:text-2xl text-center font-semibold text-teal-600'>Add Task</h2>
                </div>
                <div>
                ...
                <div className='flex justify-around space-x-5'>
                    <button type='submit' className='w-full bg-teal-600 text-white p-2 rounded' > Add Task </button>
                    <button onClick={() => navigate('/')} type='button' className='w-full bg-teal-600 text-white p-2 rounded'> Cancel </button>
                </div>
            </form>
        </div>
    );
